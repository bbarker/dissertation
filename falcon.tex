...
running the Gurobi 5.6 solver \citep{gurobi}. This is still a major
...
so the efficiency in this case depends on the solver used.
...
\citep{gurobi} on Yeast 7 model, likely due to the number of branches
incurred from
