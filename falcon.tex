...
(\ref{Figure XX}). \cite{Chubukov2013} show that many fluxes are not
under direct control of their associated enzyme complex expression
level, which gives experimental support to the idea that a
...
constrained by expression data. \cite{Chubukov2013} also note that
