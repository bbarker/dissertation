...
Our goal is to implement software that allows fitting fluxes from
expression data and genome-scale models and relatedly, the
manipulation of GPR rules found in genome-scale models. To this end we
implement or improve the algorithms described in \citealt{Lee2012} and
\citealt{Barker2014}.  Additionaly we describe the use of the code in
more detail so that users may quickly perform analysis usign the
software. Finally, we extend the above implementations to work in
Python.
