...
distribution will be placed further away from the wild-type in the latter
case. Thus, it is preferable to sample a high percentage of mutations
that are closer to the wild-type in order to generate a beneficial
mutation distribution conforming to extreme value theory.  It can be
