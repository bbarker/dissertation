...
to nearly neutral and slightly deleterious mutations, or adaptive
...
The occurrence of beneficial mutations and how they affect adaptation
...
To accommodate these weights, let $w$ be a positive scalar weight, and
...
10 beneficial mutations from over 150 total beneficial mutations in a
...
class of mechanistic models, encompassing those used in this study,
...
mutations that are represented as gene expression perturbations. A
...
mutations, nor of exploring them combinatorially, as the time needed
for a single mutant takes at least a day even in the smallest
bacterial model \citep{Karr2012}. Future insights into improving the
...
\centering
  ...
  occurring within the larger FVA bound).}
