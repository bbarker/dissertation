...
that it simulates a continuous range of fitnesses (quadratic
programming does not admit alternative optima either, except possibly
in rare boundary cases), potentially matching any required fitness
level exactly.
