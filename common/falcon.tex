...
The MoMA method, framed as a constrained least-squares optimization
...
the manual choice of a flux and complex abundance pair with a ratio that
...
are constrained to operate in one direction only. This is not
...
\newlength{\expSensLen}
\setlength{\expSensLen}{0.7\textwidth}
\begin{figure}[H]
\centering
\begin{tabular}{c}
