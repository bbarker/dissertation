...
\\
\end{tabular}
\caption{Correlation between two types of proteomic data \textbf{(a)}; 
...
these proteomic datasets (with zeros removed) are correlated with an mRNA dataset 
\hl{what kind and which?}.}
...
still be gleaned from analyzing RNA-Seq data, but, an appropriate
