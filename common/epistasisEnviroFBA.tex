...
which each epistatic interaction exists. Note that about 26\% of
epistatic relations are extremely stable (the very right bar) and
...
used for \Figs \ref{fig:eefS2} and \ref{fig:eefS4}.
}

\newcommand{\eeFBATabSTwoCap}{% 
Condition-specific epistases and sign-epistases prevalence in the
iMM904 yeast model.
}
...
\begin{figure}[!htb]
\centering
\includegraphics[height=0.75\textheight]{envFigure_1}
\caption{\eeFBAfigOneCap}
\label{fig:eef1}
\end{figure}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\textwidth]{envFigure_2}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.85\textwidth]{envFigure_3}
\caption{\eeFBAfigThreeCap}
\label{fig:eef3}
\end{figure}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=\textwidth]{envFigure_4BW}
\caption{\eeFBAfigTwoCap}
\label{fig:eef4}
\end{figure}
...
% \begin{figure}[h]
% \centering
% \includegraphics[height=0.75\textheight]{envFigure_5}
% \end{figure}
% }{}
...
largely unchanged (\Figs \ref{fig:eefS2} and \ref{fig:eefS4}; Table S1).
...
DEB-0949556 and NIH 1R01AI085286 awarded to Z.G, and the 
Tri-Institutional fellowship, awarded to B.B.
