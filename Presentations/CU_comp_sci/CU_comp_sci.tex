...
% Should convert to a \makelogo command
\begin{center}
%\centering
\newcommand{\TriIHeight}{0.6in} %make this a logo parameter
\begin{tabular}{ccc} %width=0.3\textwidth

  \includegraphics[height=\TriIHeight]{CULogo187_crop}
&
  \includegraphics[height=\TriIHeight]{mskcc}
&
  \includegraphics[height=\TriIHeight]{CU_Weill}
\\
\end{tabular}
\end{center}
