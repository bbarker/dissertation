...
\newsavebox{\toynet}
\savebox{\toynet}{  
\includegraphics*[width=0.5\textwidth, viewport=0 418 708 718, clip=true]
{SmatExample}  }

\newsavebox{\toySmat}
\savebox{\toySmat}{
\includegraphics*[width=0.5\textwidth, viewport=0 0 708 418, clip=true]
{SmatExample} }
...
\put(0,\textheight){\makebox(\textwidth, 0)[lt]{\usebox{\toynet}}}
\put(0.01\textwidth,0.95\textheight){\usebox{\hideLetter}}

\end{picture}
} % end of \frame

% \\
%\put(0, \textheight}{\usebox{\toySmat}}

%\put(\textwidth, \textheight){)\includegraphics*[width=\textwidth, viewport=411 793 643 938, clip=true]
%{SmatExample}}
%\\
