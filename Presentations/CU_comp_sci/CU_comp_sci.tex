...
\note{
\scriptsize
``   `` Thanks. It has been good meeting everyone
...
operations that should only be performed on rules ins conjunctive normal form
...
reactions.  This objective shown is a simiplified formulation of the
