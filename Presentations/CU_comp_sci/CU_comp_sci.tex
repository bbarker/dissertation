...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Collaborated on statistical phylogenetics (``tree of life'' problems)
  \end{itemize}
  } % end of \only<3>
  \alert<4>{
...
My studies have focused on optimization and mathematical
...
\begin{itemize}
  ...
  \end{itemize}
  \item Several interested Cornell faculty
\end{itemize}
...
on kickstarter with a \$125,000 backing.
\par
...
especially a number of groups at Cornell, would be interested
