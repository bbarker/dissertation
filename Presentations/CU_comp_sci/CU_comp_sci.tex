...
operating systems concepts and skills. In college, I participated in
...
\vspace{1ex}\hrule\vspace{1ex}
\textit{the width of the road for a reaction}\\
\end{block}
}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.5\textwidth]{centraldogma} %
& %
\includegraphics[width=0.5\textwidth]{2F43} %
\end{tabular}
\end{figure}
...
\frame{\frametitle{Boolean gene rules can be used to quantify enzyme complexes}
...
\begin{frame}[fragile]
\frametitle{An efficient pipeline for going from gene expression to flux}
