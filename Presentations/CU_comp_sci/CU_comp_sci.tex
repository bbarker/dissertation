...
Now that we've discussed the GPR rule effects in detail, I'd like
to introduce improvements to the flux fitting algorithm. 
\par
...
Make a figure giving a brief overview of the fitting algorithm(s)?\\
