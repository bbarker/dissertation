...
\includegraphics[height=\textheight]{SmatExample.eps}
...
\frame{\frametitle{How did we get here?}
...
\hl{Expain gene expression somewhere.}\\
\hl{relevance to disease (Diabetes, Cancer, etc.)}
%With GPR rules, a new way to formulate objectives (Lee et al. 2012).
...
\begin{figure}
\underline{Many pairwise simulations reveal complex trends.}
\centering
