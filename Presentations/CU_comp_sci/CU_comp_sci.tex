...
correlation between flux vectors estimated based on the perturubed and
...
%  \begin{subfigure}{\subtract{1}{\fluxfigwidth}\textwidth}
  \raisebox{0.3\height}{\includegraphics[scale=0.4,center]{legend_bars}}
  \caption{\the\fluxlegwidth}
  \end{subfigure}
\\
\end{tabular}
%\caption{\only<1>{glucose}\only<2>{ethanol}\only<3>{$CO_2$}}
