...
\includegraphics[resolution=72, width=\textwidth, viewport=13 730 671 1146, clip=true]
{SmatExample}
\\
\includegraphics[resolution=72, width=\textwidth, viewport=13 439 722 722, clip=true]
{SmatExample}
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[resolution=72, width=\textwidth, viewport=13 13 722 435, clip=true]
{SmatExample}
\end{column}
