...
subcomplexes; redundant subcomplexes---as elaborated in (2) above---are not currently modeled. 
\end{enumerate} \\
\hline
\end{tabular}
\end{center}
...
hierarchical structure in mind, though it is likely the case most of
the time, as this is a natural way to think about complexes. However,
we now argue that any GPR rule can be interpreted in the context of
