...
Now we show that the reduction step does not change the result from
the algorithm. The third step in the while-loop does not affect the
...
immediately arrive at $(x_1) \lor (x_3)$, which is our originally
assumed minimum.
