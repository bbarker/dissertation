...
$\alpha$ and $\beta$ subunit Each $\alpha\beta$ pair works together to bind
ADP and catalyze the reaction (cite). It is obvious that one of these
base-level functional subcomplexes (in this example, either $\gamma$ or $\alpha\beta$
will be in most limited supply, and
that it will best represent the overall enzyme complex copy number. 
