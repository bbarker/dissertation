...
% robust algorithms for the estimation metabolic flux and enzyme complex abundance.

% //Expression and Gene-Protein-Reaction rules can be employed in a non-trivial way to 
% estimate enzymme complex abundanc.
