...
\texttt{makeMethodFigures.m} by first setting the variable
\texttt{figName} to the value corresponding to the desired figure.
In some cases, some MATLAB \texttt{.mat} files will need to be
generated by other scripts first; see the plotting scripts or the
