...
\begin{tabular}{cc}
  ...
  \includegraphics[width=\textwidth]{expCmpY7HC}
  \caption{Highly constrained.} \label{fig:EnzAbundEval:A}
  \end{subfigure}
&
  \begin{subfigure}[b]{0.5\textwidth}
  \includegraphics[width=\textwidth]{expCmpY7MC}
  \caption{Minimally constrained.} \label{fig:EnzAbundEval:B}
  \end{subfigure} 
\\
  \begin{subfigure}[b]{0.5\textwidth}
  \includegraphics[width=\textwidth]{expCmpR2HC}
  \caption{Highly constrained.} \label{fig:EnzAbundEval:C}
  \end{subfigure}
&
  \begin{subfigure}[b]{0.5\textwidth}
  \includegraphics[width=\textwidth]{expCmpR2dC}
...
&
  \begin{subfigure}[b]{0.48\textwidth}
  \raisebox{0.4\height}{\includegraphics[scale=0.3,center]{legend_bars}}
  \end{subfigure} 
\\
  \begin{subfigure}[b]{0.48\textwidth}
