...
At the time of this release, \texttt{solveFalconLP} should be
...
parameters. The preferred parameter settings may change for future
releases of FALCON or its successors.
