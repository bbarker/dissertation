...
\begin{figure}
\centering
\includegraphics[height=0.8\textheight]{envFigure_S2}
\end{figure}
}
...
percentage of negative epistatic interactions.}
...
\begin{itemize}
\item Developed a parallel pipeline for partial-flux epistases
...
\frame{\frametitle{Condition specificity of epistatic interactions}
...
\vspace{1ex}
Formulated as a constrained quadratic (least-squares)\\ optimization problem (Segr\`e et al 2002):\\
\begin{center}
...
flowchart; the first two processes are implemented in a Standard ML
...
{\normalsize
With Lin Xu, Tim Connallon, and Zhenglong Gu
}
...
\end{itemize}
\item Complex systems have a lower percentage of accessible evolutionary paths
...
\begin{itemize}
\item Tim Connallon
\item \textbf{Zhenglong Gu}
\item Jason W. Locasale
\item \textbf{Chris Myers}
...
\item Eli Bogart
\item \textbf{David Christini}
\item Ben Heavner
\item Lei Huang
\item \textbf{Michael Stillman}
\item Neil Swainston
\item Marc Warmoes
\item Lin Xue
\item Kaixiong Ye
